...
public class SoapHelper {
    ...
    private MantisConnectPortType getMantisConnect() throws ServiceException, MalformedURLException, RemoteException {
        URL urlConnect = new URL(app.getProperty("web.urlConnect"));
        return new MantisConnectLocator()
                .getMantisConnectPort(urlConnect);
    }
    ...
    public IssueData getIssue(int issueId) throws RemoteException, ServiceException, MalformedURLException {
        MantisConnectPortType mc = getMantisConnect();
        String adminLogin = app.getProperty("web.adminLogin");
        String adminPassword = app.getProperty("web.adminPassword");
        return mc.mc_issue_get(adminLogin, adminPassword, BigInteger.valueOf(issueId));
    }
}
